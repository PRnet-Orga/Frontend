...
function Footer() {
  return (
    <div className='w-full bg-[rgba(241,236,245)] rounded-t-[36px] mt-[-20px]  h-[180px] max-xl:h-auto flex justify-between items-center px-[21rem]  max-[1459px]:px-[10rem] max-[768px]:px-[2rem] max-[493px]:gap-4 max-[493px]:items-start'>
